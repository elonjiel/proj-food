    ...
    <Link to ={`/recipes/${id}`} className="w-full md:w-[245px]">
        <div className="bg-_gradient shadow w-full rounded-lg">
          ...
          <div className='p-3'>
                    ...
                    <div className='mt-2'>
                        <span className='px-2 py-1 text-[14px] lowercase bg-stone-100/20	 shadow-xl rounded-full mr-3 text-yellow-400'>
                            {cuisineType}
                        </span>
                        <span className='px-2 py-1 text-[14px] lowercase bg-stone-100/20	 shadow-xl rounded-full text-yellow-400'>
                            {mealType}
                        </span>
                    </div>
                </div>
