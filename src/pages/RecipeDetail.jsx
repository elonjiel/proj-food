          ...
          <div className="w-full flex flex-col md:flex-row gap-8 py-20 pxx-4 md:px-10">
            ...
            <div className="w-full md:w-2/4 md:border-r border-slate-700 pr-1">
              <div className="flex flex-col gap-5 ">
                  <p className="text-yellow-400 text-2xl underline">Ingredients</p>
                  {
                  recipe?.ingredientLines?.map((ingredient, index) => {
                    return (
                      <p key={index} className="text-neutral-100 flex gap-2">
                        <AiFillPushpin className="text-yellow-400 text-xl" /> {ingredient}
                      </p>
                      )
                    })
                  }
            ...
            <div className="flex flex-col gap-3 mt-20">
                <p className="text-yellow-400 text-2xl underline">Health Labels</p>

                <div className="flex flex-wrap gap-4">
                  {
                    recipe?.healthLabels.map((item, index) => (
                      <p className="text-white flex justify-center items-center gap-2 bg-[#fff5f518] px-4 py-1 rounded-full" key={index}>
                        <BsPatchCheck className="text-yellow-400" /> {item}
                      </p>
                    ))
                  }
